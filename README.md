...
![GitHub License](https://img.shields.io/github/license/H0NEYP0T-466/dld-workbench?style=for-the-badge&color=brightgreen)
![GitHub Stars](https://img.shields.io/github/stars/H0NEYP0T-466/dld-workbench?style=for-the-badge&color=yellow)
![GitHub Forks](https://img.shields.io/github/forks/H0NEYP0T-466/dld-workbench?style=for-the-badge&color=blue)
![Contributions Welcome](https://img.shields.io/badge/Contributions-Welcome-brightgreen?style=for-the-badge)
![GitHub Issues](https://img.shields.io/github/issues/H0NEYP0T-466/dld-workbench?style=for-the-badge&color=red)
...
```
dld-workbench/
├── 7-Segment(digital number)/       # 7-segment display circuits
├── Assignment#3/                    # Advanced lab assignments
├── Assingment#1/                   # Basic logic assignments
├── Assingment#2/                   # Intermediate assignments
├── Full-Adder/                     # Full adder implementations
├── Full-Subtractor/                # Full subtractor circuits
├── Half-Adder/                     # Half adder designs
├── Half-Subtractor/                # Half subtractor circuits
├── K-MAP(3- Variables)/            # Karnaugh map examples
├── LogicGate#1/                    # Basic logic gate circuits
├── Project/                        # Main project files
├── Project Backups/                # Backup project files
├── Quiz#2/                         # Quiz implementations
├── Sop/                           # Sum of Products circuits
├── demux/                         # Demultiplexer circuits
├── pos/                           # Product of Sums circuits
├── Proposal DLD.docx              # Project proposal document
└── Water Level Indicator Project.pdsprj  # Main project file
```
...
|------------|---------|---------------|
| ![Proteus](https://img.shields.io/badge/Proteus-Design_Suite-blue?style=for-the-badge) | Circuit Design & Simulation | [labcenter.com](https://www.labcenter.com/) |
| ![Digital Logic](https://img.shields.io/badge/Digital-Logic_Design-green?style=for-the-badge) | Core Concepts | [Digital Electronics](https://en.wikipedia.org/wiki/Digital_electronics) |
| ![Electronics](https://img.shields.io/badge/Electronics-Simulation-orange?style=for-the-badge) | Hardware Modeling | [Circuit Simulation](https://en.wikipedia.org/wiki/Electronic_circuit_simulation) |
...
### ✅ Current Features
- [x] Basic logic gate circuits
- [x] Combinational circuit designs
- [x] 7-segment display implementations
- [x] Water level monitoring system
- [x] Fire detection circuits
- [x] Educational assignments and labs
